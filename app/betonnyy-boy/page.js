...
export default function BetonnyyBoyPage() {
  return (
    <main style={{ 
      ...
      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        И да, я знаю, что многие боятся радиации в бетонном бое. Я тоже переживал. Поэтому я купил <a href="https://www.ozon.ru/product/dozimetr-radiatsii-radex-rd1224si-radiometr-1726613857/" target="_blank" rel="noopener noreferrer">дозиметр RADEX RD1224Si</a> — он быстро реагирует на источники радиации, показывает точные цифры. Я залазил в кузов каждой машины и замерял фон. Всё было в норме, но лучше перебдеть, чем потом жить на радиоактивном участке.
      </p>
      ...
      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        <strong>Важный совет:</strong> прикреплять геотекстиль колышками, чтобы его не разорвало тракторами, смысла нет — они всё равно не выдержат. Но прикреплять нужно обязательно, чтобы ветер не развернул его как парус и не раскидал по участку. Это огромные полотна, и ветер с ними справляется легко. Ещё один момент: нахлёст делайте минимум полметра. Мои 15 сантиметров — это была ошибка, в некоторых местах разъехалось до земли.
      </p>
      ...
      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        <strong>По кротам:</strong> если бы я знал, я бы перед укладкой геотекстиля постелил мелкоячеистую сетку от грызунов. Это решило бы проблему на корню. Так что мой главный совет: если будете повторять мой опыт — не поленитесь, постелите сетку сначала. Потом будет уже поздно, как у меня.
      </p>

      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        <strong>По геотекстилю:</strong> прикреплять его колышками, чтобы он не разъехался от машин, смысла нет — они всё равно не выдержат. Но прикреплять нужно, чтобы ветер не развернул его как парус и не раскидал по участку. Это огромные полотна, и ветер с ними справляется легко. Нахлёст делайте минимум полметра. Мои 15 сантиметров — это была ошибка, в некоторых местах разъехалось до земли.
      </p>

      <h2 style={{ textAlign: 'center' }}>Как выглядит сейчас и что в планах</h2>
      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        Моя идея с бетонным боем и водой на участке оправдала себя. После дождей я приезжаю и вижу, как у меня абсолютно сухие (относительно, конечно) камни, по которым можно ходить. Луж нет — они все под камнями. Благодаря небольшому уклону участка (всего 2 градуса) вода постепенно стекает в сторону дороги, где в будущем будет общая канава. А у соседей на участках — болото.
      </p>
      ...
      <p style={{ textAlign: 'left', maxWidth: '860px', margin: '0 auto' }}>
        В целом, решение было правильным. Но теперь у меня есть для вас несколько железных советов: <strong>сетка от кротов, большой нахлёст геотекстиля, проверка радиации дозиметром</strong>. Не повторяйте мои ошибки.
      </p>
