...
export default function BetonnyyBoyPage() {
  return (
    <main style={{ maxWidth: '900px', margin: '0 auto', padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p><strong>Всем привет!</strong> Я самостройщик с дивана. По сути, я — это ты. Потому что всё, что сделал я, сможешь сделать и ты, раз у тебя есть доступ к YouTube, голова и руки.</p>

      <p>У меня уже был участок и дом, и этот опыт я считаю неуспешным. Я строил всё сам по YouTube, по сути, и многое там было сделано с косяками. Именно их я хочу учесть при новом строительстве.</p>
